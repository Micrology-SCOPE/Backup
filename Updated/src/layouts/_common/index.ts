...
export { default as CheckForUpdate } from './check-for-update';
export { default as RedirectToDashboard } from './redirect-to-dashboard';
export { default as SerialNumber } from './serial-number';
export { default as BrandName } from './brand-name';
